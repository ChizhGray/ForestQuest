...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class InsertLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>koin</b> with <b>io.insert-koin:koin-android</b> coordinates and
         * with version reference <b>koin</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getKoin() {
            return create("insert.koin");
        }

    }

    public static class OrgLibraryAccessors extends SubDependencyFactory {
        private final OrgOrbitLibraryAccessors laccForOrgOrbitLibraryAccessors = new OrgOrbitLibraryAccessors(owner);

        public OrgLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>org.orbit</b>
         */
        public OrgOrbitLibraryAccessors getOrbit() {
            return laccForOrgOrbitLibraryAccessors;
        }

    }

    public static class OrgOrbitLibraryAccessors extends SubDependencyFactory {

        public OrgOrbitLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>compose</b> with <b>org.orbit-mvi:orbit-compose</b> coordinates and
         * with version reference <b>orbit</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCompose() {
            return create("org.orbit.compose");
        }

        /**
         * Dependency provider for <b>core</b> with <b>org.orbit-mvi:orbit-core</b> coordinates and
         * with version reference <b>orbit</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCore() {
            return create("org.orbit.core");
        }

        /**
         * Dependency provider for <b>viewmodel</b> with <b>org.orbit-mvi:orbit-viewmodel</b> coordinates and
         * with version reference <b>orbit</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getViewmodel() {
            return create("org.orbit.viewmodel");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>koin</b> with value <b>3.1.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>orbit</b> with value <b>4.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>room</b> with value <b>2.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
